...
namespace AZ::ShaderCompiler
{
    ...
    struct IntermediateRepresentation : public PreprocessorLineDirectiveFinder
    {
        ...
        //! In such case the "float" or "float2" must be prepadded by a float3 variable.
        //! 
        ...
        //! In such case the "float" must be prepadded by a float2 variables.
        //! 
        ...
        //! }
        //!  
        void PrepadScalarOrFloat2WhenPrecededByMatrix(const MiddleEndConfiguration& middleEndconfigration);
