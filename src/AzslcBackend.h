...
namespace AZ::ShaderCompiler
{
    ...
    struct Options
    {
        ...
        bool m_indirect = false; //!< If set, routes SRV bindings indirectly through managed resource heaps.
        ...
        std::unordered_set<std::string> m_entryPoints; //!< Set of entry points known for a given shader. Used to initialize static SRV descriptors when indirect binding is active.
    };
